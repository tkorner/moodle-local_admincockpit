...
$string['expiredenrolments'] = 'Abgelaufene Einschreibungen';
$string['expiredenrolments_expiredon'] = 'Abgelaufen am';
$string['expiredenrolments_intro'] = 'Einschreibungen, die noch aktiv sind, deren Enddatum aber bereits vorbei ist. Je nach Einschreibemethode werden diese nicht automatisch bereinigt - öffne die Teilnehmerliste des Kurses, um sie zu verlängern oder zu entfernen.';
$string['expiredenrolments_none'] = 'Keine abgelaufenen Einschreibungen gefunden - hier gibt es nichts zu melden.';
$string['expiredenrolments_truncated'] = 'Es werden die ersten 500 von {$a} abgelaufenen Einschreibungen angezeigt.';
...
$string['healthsignals_available'] = 'Die eigenen, integrierten Signale dieses Plugins: local_admincockpit:duplicateemails, local_admincockpit:courseswithoutenddate, local_admincockpit:unpublishedcourses, local_admincockpit:expiredenrolments, local_admincockpit:selfenrolrisks, local_admincockpit:security, local_admincockpit:cron. Ein Signal eines Drittanbieter-Plugins verwendet dessen eigenen Komponentennamen statt local_admincockpit - den genauen Schlüssel findest du auf dem Dashboard selbst oder in der Dokumentation dieses Plugins.';
...
$string['loginas_heading'] = 'Als Nutzer/in anmelden';
$string['loginas_intro'] = 'Nutzer/in suchen und direkt in deren Sitzung wechseln, ohne vorher über die Teilnehmerliste eines Kurses zu gehen. Site-Administrator/innen können nicht ausgewählt werden. Deine eigene Sitzung wird wiederhergestellt, sobald du die fremde Sitzung beendest.';
$string['loginas_label'] = 'Nutzer/in';
$string['loginas_noselection'] = 'Niemand ausgewählt';
$string['loginas_nouserselected'] = 'Wähle aus, als wen du dich anmelden möchtest.';
$string['loginas_refused'] = 'Du kannst dich nicht als diese/n Nutzer/in anmelden.';
$string['loginas_submit'] = 'Als diese/n Nutzer/in anmelden';
...
$string['selfenrolrisks'] = 'Selbsteinschreibung ohne Schlüssel oder Enddatum';
$string['selfenrolrisks_finding'] = 'Befund';
$string['selfenrolrisks_intro'] = 'Aktivierte Selbsteinschreibungen ohne Einschreibeschlüssel, ohne Enddatum oder ohne beides. Jede davon lässt einen Kurs unbeaufsichtigt weiter Einschreibungen annehmen - öffne die Einschreibemethoden des Kurses, um einen Schlüssel oder ein Enddatum zu setzen.';
$string['selfenrolrisks_noenddate'] = 'Kein Enddatum';
$string['selfenrolrisks_nokey'] = 'Kein Einschreibeschlüssel';
$string['selfenrolrisks_none'] = 'Keine Selbsteinschreibungen ohne Schlüssel oder Enddatum - hier gibt es nichts zu melden.';
$string['selfenrolrisks_truncated'] = 'Es werden die ersten 500 von {$a} Selbsteinschreibungen angezeigt.';
