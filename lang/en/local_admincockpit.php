...
$string['loginas_heading'] = 'Log in as a user';
$string['loginas_intro'] = 'Search for a user and switch straight into their session, without going through the course participants list first. Site administrators cannot be selected. Your own session is restored when you log out of the impersonated one.';
$string['loginas_label'] = 'User';
$string['loginas_noselection'] = 'No user selected';
$string['loginas_nouserselected'] = 'Select the user you want to log in as.';
$string['loginas_refused'] = 'You cannot log in as that user.';
$string['loginas_submit'] = 'Log in as this user';
