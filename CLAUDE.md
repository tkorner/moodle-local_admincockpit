...
**Progress:** Steps 0 through 12 are implemented and released (see release 1.0.0/1.1.0/1.1.1/2.0.0 commits); the code-review follow-up pass (2026-07-16) is complete and released (1.1.1). Marketplace-submission prep has been running since 2026-07-22, see the "Marketplace-Submission" section below. Step 13 (fix: "active" metrics follow the selected time range instead of a fixed 4 weeks, both globally and per school) is implemented and released as 2.1.0/2.1.1 (2026-07-29). Steps 14-20 (health signal extension hook via the Moodle Hooks API, the "unpublished courses" signal as its dogfood consumer, the enable/disable/ordering settings, and the "Purge ALL site caches" quick action) are implemented, released as 2.2.0 (2026-08-02) - see README "Extending: add your own health signal" and SPEC section 11 for the third-party-facing documentation and the rationale for choosing hooks over a raw-SQL settings field or a formal subplugin relationship.
